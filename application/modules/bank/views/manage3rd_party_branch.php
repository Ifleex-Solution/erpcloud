...
<div class="row">
    <div class="col-sm-12">
        <div class="panel panel-bd lobidrag">
            ...
            <button type="button" id="btn-create" class="btn btn-success" style="margin-left: 30px;margin-top:20px;"><i class="fas fa-plus"></i>Add Branch</button>

            <div class="panel-body">
                <div class="table-responsive">
                    <table class="table table-striped table-bordered" cellspacing="0" width="100%" id="branchList">
                        <thead>
                            <tr>
                                <th>No</th>
                                <th>Bank</th>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="form-group row">
                    <label for="cheque_no" class="col-sm-4 col-form-label">Banks
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="text" tabindex="3" class="form-control" name="branch_name[]" placeholder="Branch Name" id="branchname" required />
                    </div>
                </div>
...
<script>
    ...
    btnSave.addEventListener('click', function() {
        ...
        if ($('#banks').val() ==null) {
            ...
            $.ajax({
                type: "post",
                url: base_url + 'bank/bank/savebranch',
                data: {
                    bank: $('#banks').val(),
    ...
    $(document).ready(function() {
        ...
        $.ajax({
            type: "post",
            url: base_url + 'bank/bank/getAllBranches',
            data: {
