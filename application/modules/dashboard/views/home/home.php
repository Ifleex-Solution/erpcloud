            ...
            <div class="panel-heading">
                <div class="panel-title">
                    <h4 class="best-sale-title">
                        <?php echo display('best_sale_product') ?>
                    </h4>
    ...
    <div class="col-md-4 d-flex">
        <div class="panel panel-bd lobidisable flex-fill w-100">
            <div class="panel-heading">
                <div class="panel-title">
                    <h4>
                        <?php echo display('todays_overview') ?>
                    </h4>
                </div>
            </div>
            <div class="panel-body">
                    ...
                    <div class="message_widgets">
                        ...
                        <table class="table table-bordered table-striped table-hover">
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php echo html_escape((($position == 0) ? "$currency $sales_amount" : "$sales_amount $currency")) ?>
                                </td>
                            </tr>
                            <tr>
                                <th>
                                    <?php echo display('total_purchase') ?>
                                </th>
                                <td>
                                    <?php echo html_escape((($position == 0) ? "$currency $todays_total_purchase" : "$todays_total_purchase $currency")) ?>
                                </td>
                            </tr>
                        ...
                        <table class="table table-bordered table-striped table-hover">
                            ...
                            <tr>
                                <th>
                                    <?php echo $tsale['product_name']?>
                                </th>
                                <td>
                                    <?php echo (($position == 0) ? $currency.' '.$tsale['price'] : $tsale['price'].' '.$currency) ?>
                                </td>
                            </tr>
                    ...
                    <table class="table table-bordered table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php echo html_escape($sales_due->customer_name); ?>
                                </td>
                                <td>
                                    <a
                    ...
                    <table class="table table-bordered table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php echo html_escape($purchase_due->supplier_name); ?>
                                </td>
                                <td>
                                    <a
